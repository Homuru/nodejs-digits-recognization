...
X, y = loadlocal_mnist(
    images_path='/home/homuru/python/python3/mnist/t10k-images.idx3-ubyte',
    labels_path='/home/homuru/python/python3/mnist/t10k-labels.idx1-ubyte')

# data_train = X
# target_train = y
data_test = X
target_test = y
img = cv2.imread('/home/homuru/nodejs-digit-recognition/public/image.png', 0)
img = 255-img
hor = np.zeros((20,4))
ver = np.zeros((4,28))
